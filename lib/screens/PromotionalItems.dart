...
class PromotionalItems extends StatefulWidget {
  @override
  _PromotionalItemsState createState() => _PromotionalItemsState();
}

class _PromotionalItemsState extends State<PromotionalItems> {
  bool isSearch = false;
  String filter = "";
  int page = 1;
  bool firstLoad = true;
  ...
  suggestion() async {
    ...
    var result = await http.get(
      Uri.parse(Constants.App_url + Constants.promotionNames),
      headers: {
  ...
  Future<List<ProductDataType>> getItems() async {
    try {
      ...
      print(Constants.App_url +
          ...
          "?page=$page&orderby=$filter&searchkey=$searchString");
      //print(result);
      print("first call over and second call start");
